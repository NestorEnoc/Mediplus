...
class EditarModuloVidaSaludable : AppCompatActivity() {
    ...
    private fun validarCampos(): Boolean {
        ...
        val actividad = findViewById<EditText>(R.id.txtActividadEditar).text.toString().trim()
        val fecha = findViewById<EditText>(R.id.txtFechaActividadEditar).text.toString().trim()
        val hora = findViewById<EditText>(R.id.txtHoraActividadEditar).text.toString().trim()
        val categoria = findViewById<EditText>(R.id.txtCategoriaActividadEditar).text.toString().trim()
        val descripcion = findViewById<EditText>(R.id.txtDescripcionActividadEditar).text.toString().trim()

        // Referencias a los EditText
        val inputLayoutActividad = findViewById<EditText>(R.id.txtActividadEditar)
        val inputLayoutFecha = findViewById<EditText>(R.id.txtFechaActividadEditar)
        val inputLayoutHora = findViewById<EditText>(R.id.txtHoraActividadEditar)
        val inputLayoutCategoria = findViewById<EditText>(R.id.txtCategoriaActividadEditar)
        val inputLayoutDescripcion = findViewById<EditText>(R.id.txtDescripcionActividadEditar)
        ...
        inputLayoutActividad.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                if (s.isNullOrEmpty()) {
                    ...
                    inputLayoutActividad.error = "Por favor, seleccione una enfermedad" // Error visible
                } else {
