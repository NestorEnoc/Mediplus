...
class CrearModuloCitas : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_crear_modulo_citas)
        ...
        val seleccionEspecialidad: MaterialAutoCompleteTextView = findViewById(R.id.txtEspecialidad)
        ...
        editTextDate = findViewById(R.id.txtFechaCitaCrear)
        ...
        btnSelectTime = findViewById(R.id.txtHoraCitaCrear)
        ...
        findViewById<LinearLayout>(R.id.btnCrearRecordatorioCitaMedica).setOnClickListener {
            if (validarCampos()) {
                registrarCitaMedica()
            }else{
    ...
    private fun registrarCitaMedica() {
        val db = FirebaseFirestore.getInstance()

        // Obtener los nuevos datos de los EditText (cambia los IDs según tu layout)
        val especialidad = findViewById<EditText>(R.id.txtEspecialidad).text.toString()
        val fecha = findViewById<EditText>(R.id.txtFechaCitaCrear).text.toString()
        val hora = findViewById<EditText>(R.id.txtHoraCitaCrear).text.toString()
        val nombre_medico = findViewById<EditText>(R.id.txtNombreMedicoCitaCrear).text.toString()
        val descripcion = findViewById<EditText>(R.id.txtDescripcionCitaCrear).text.toString()
        ...
        val gestionSaludData = hashMapOf(
            ...
            "fecha" to fecha,
            "hora" to hora,
            "nombre_medico" to nombre_medico,
        ...
        db.collection("toma_citas")
            ...
            .addOnFailureListener { e ->
                Toast.makeText(this, "Error al registrar la cita: ${e.message}", Toast.LENGTH_SHORT).show()
            }
    }
    // Método para redirigir a la actividad de confirmación
    private fun redirectToConfirmation() {
        startActivity(Intent(this, ConfirmacionRecordatorioCitas::class.java))
        finish()
    }
    ...
    private fun validarCampos(): Boolean {
        ...
        val especialidad = findViewById<EditText>(R.id.txtEspecialidad).text.toString().trim()
        val fecha = findViewById<EditText>(R.id.txtFechaCitaCrear).text.toString().trim()
        val hora = findViewById<EditText>(R.id.txtHoraCitaCrear).text.toString().trim()
        val medico = findViewById<EditText>(R.id.txtNombreMedicoCitaCrear).text.toString().trim()
        val descripcion = findViewById<EditText>(R.id.txtDescripcionCitaCrear).text.toString().trim()

        // Referencias a los EditText
        val inputLayoutEspecialidad = findViewById<EditText>(R.id.txtEspecialidad)
        val inputLayoutFecha = findViewById<EditText>(R.id.txtFechaCitaCrear)
        val inputLayoutHora = findViewById<EditText>(R.id.txtHoraCitaCrear)
        val inputLayoutMedico = findViewById<EditText>(R.id.txtNombreMedicoCitaCrear)
        val inputLayoutDescripcion = findViewById<EditText>(R.id.txtDescripcionCitaCrear)
